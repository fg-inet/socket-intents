...
int muacc_sa_setsockopt(muacc_context_t *ctx, int socket, int level, int option_name,
...
int muacc_sa_getsockopt(muacc_context_t *ctx, int socket, int level, int option_name,
