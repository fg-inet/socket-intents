...
{
	printf("Policy module \"mptcp_simple\" is loading.\n");
	...
	printf("\nPolicy module \"mptcp_simple\" has been loaded.\n");
	return 0;
}
...
int cleanup(mam_context_t *mctx)
{
	...
	printf("Policy mptcp_simple library cleaned up.\n");
	return 0;
}
